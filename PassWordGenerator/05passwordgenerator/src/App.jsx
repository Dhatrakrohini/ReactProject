      ...
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-400 bg-gray-600'>
        ...
        <div className='flex text-sm gap-x-2 '>
          ...
          <div className='flex text-sm gap-x-2 '>
            ...
            <label htmlFor="numerInput">Numbers:{numberAllowed}</label>
          </div>
          <div className='flex text-sm gap-x-2 '>
            <input type="checkbox" defaultChecked={charAllowed} id='numberInput' onChange={() => { setCharacterAllowed((prev) => !prev); }} />
